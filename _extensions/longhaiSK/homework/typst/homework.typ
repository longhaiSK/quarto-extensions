...
/* --- Paragraph Settings --- */
#show par: set block(spacing: 1em) /* Increases the space between paragraphs */

#set par(
  leading: 1em, /* Line spacing within the same paragraph */
  justify: true
)

/* --- List & Enum Settings --- */
/* Increases the vertical gap between separate list items */
#set list(spacing: 1.2em)
#set enum(spacing: 1.2em)

/* Increases the internal line spacing for text/equations wrapped within the same item */
